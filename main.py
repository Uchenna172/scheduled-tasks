...
# HINT 3: Use the replace() method to replace [NAME] with
# the actual name. https://www.w3schools.com/python/ref_string_replace.asp
...
MY_EMAIL = "my.python.testing123"
PASSWORD = "vntb glqi dkmg svwc"
...
if today_tuple in birthdays_dict:
    ...
    with open(filepath) as data_file:
        ...
        replaced_name = contents.replace("[NAME]", birthday_person["name"])
